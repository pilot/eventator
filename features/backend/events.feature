...
Scenario: Admin should have access to the event manage
    ...
    And I should see the row containing "2;His event;April 1, 2016 10:00;April 1, 2016 18:00"
...
Scenario: Admin should have able to add event
    ...
    Then I should see the row containing "3;Test event;UA;May 1, 2016 10:00;May 1, 2016 18:00"
...
Scenario: Admin should have delete to the event
    ...
    Then I should not see the row containing "2;His event;April 1, 2016 10:00;April 1, 2016 18:00"
