@backend
Feature: Organizers settings
    In order to change organizers settings
    As an admin
    I should be able to edit organizers settings
...
@javascript
Scenario: Admin should have access to the organizers manage
    Given I am sign in as admin
    When I click "Organizers"
    Then I wait for a form
    Then I should see "Add organizer"
    And I should see the row containing "1;My organizer;My event, His event"
    And I should see the row containing "2;His organizer;His event"
    When I click "Edit" on the row containing "2;His organizer;His event"
    Then I wait for a form
    Then I should see "Edit organizer"

@javascript
Scenario: Admin should have able to add organizer
    Given I am sign in as admin
    When I click "Organizers"
    Then I wait for a form
    Then I should see "Add organizer"
    And I click "Add organizer"
    Then I wait for a form
    Then I should see "Add organizer"
    And I fill in "Title" with "Other organizer"
    And I fill in "Description" with "Description of this organizer"
    And I fill in "Homepage" with "http://example.com"
    And I check "My event"
    And I check "His event"
    And I press "Add"
    Then I wait for a form
    Then I should see "Organizer Other organizer added."
    Then I should see the row containing "3;Other organizer;My event, His event;http://example.com"

@javascript
Scenario: Admin should have able to update organizers settings
    Given I am sign in as admin
    When I click "Organizers"
    Then I wait for a form
    Then I should see "Add organizer"
    And I should see the row containing "1;My organizer;My event, His event"
    When I click "Edit" on the row containing "1;My organizer;My event, His event"
    Then I wait for a form
    Then I should see "Edit organizer"
    And I fill in "Homepage" with "http://example.com"
    And I press "Update"
    Then I wait for a form
    Then I should see "Organizer My organizer updated."
    Then I should see the row containing "1;My organizer;My event, His event;http://example.com"

@javascript
Scenario: Admin should have delete to the organizers
    Given I am sign in as admin
    When I click "Organizers"
    Then I wait for a form
    Then I should see "Add organizer"
    ...
    Then I wait for a form
    Then I should see "Organizer deleted."
    Then I should not see the row containing "1;My organizer;My event, His event"

@javascript
Scenario: Admin should have able to update Russian organizer settings
    Given I am sign in as admin
    When I click "Organizers"
    Then I wait for a form
    Then I should see "Add organizer"
    ...
    Then I wait for a form
    Then I should see "Organizer My organizer updated."
    Then I should see the row containing "1;My organizer;My event, His event"
